...
{$IFDEF ZUSE_CONDITIONAL_FORMATTING}
  ...
  private
    ...
    FLineItemWidth: integer;          //������ ������� ����� � ���������� StyleID
...
{$IFDEF ZUSE_CONDITIONAL_FORMATTING}
  ...
  TODFCFWriterArray = record
    CountCF: integer;                   //���-�� ������
    StyleCFID: array of TODFStyleCFID;  //����� ����� c �������� ���������������
    Areas: TODFCFAreas;                 //�������
  end;
  ...
  private
    ...
    FXMLSS: TZEXMLSS;
    FStylesCount: integer;                //���-�� ������ (������� � style:map)
    FApplyCFStylesCount: integer;         //���-�� ������ ConditionalStyle_f (� styles.xml)
...
{$ENDIF} //ZUSE_CONDITIONAL_FORMATTING write
  ...
  private
    ...
    FStyles: array of TZStyle;              //����� �� styles.xml
...
uses
   StrUtils
   {$IFDEF ZUSE_CONDITIONAL_FORMATTING}, zeformula {$ENDIF} //���� ������� ����� ������ ��� ��������� ��������������
   ;
...
//INPUT
//  const StCondition: TZConditionalStyleItem - �������
//  const CurrPageName: string                - �������� ����� �� �������
//RETURN
//      string - ����� ������� ������
...
//�������� � ������ FApplyCFStyles (���������� CF � styles.xml) �����
//INPUT
//      AStyleIndex: integer  - ����������� �����
//  out retCFIndex: integer   - ������������ ������ ��������� ����� � styles.xml
...
//������ ������ � �������� ��������������� � content.xml
// (���� <style:style ...>...<style:map .../>...</style:style>)
//INPUT
//      xml: TZsspXMLWriterH - ���� ����������
...
//�������� � ������� �����
//INPUT
//  const CellNum: integer        - ����� ��������� ������
//  const AStyleCFNumber: integer - ����� ����� � ���������
...
var
  ...
  //INPUT
  //  const st: string                             - ����� ���������
  //  var ConditionOperator: TZConditionalOperator - ������������ ��������
  //RETURN
  //      boolean - true - �������� ������� ��������
  ...
  begin
    ...
    //  value
    //
    //��� LibreOffice (<calcext:conditional-formats>):
    //  between()
    //  not-between()
    //  begins-with()
    //  ends-with()
...
//INPUT
//      SheetNumber: integer            - ����� �����
//  var DefStylesArray: TZODFStyleArray - ������ �� ������� (Styles.xml)
//      DefStylesCount: integer         - ���-�� ������ � �������
//  var StylesArray: TZODFStyleArray    - ������ �� ������� (�������� �� content)
//      StylesCount: integer            - ���-�� ������ � �������
...
var
  ...
  //�������� �������� �������������� � ��������
  //INPUT
  //      CFStyle: TZConditionalStyle       - ����������� �������� �����
  //  var StyleItem: TZEODFStyleProperties  - �������� ������
...
//��������� ����� ������� ������
//INPUT
//  const BaseCellTxt: string         - ����� ������� ������
//  const ACFStyle: TZConditionalStyle  - �������� �����
//      PageNum: integer              - ����� ������� ��������
...
begin
  ...
  (*
   <calcext:conditional-format calcext:target-range-address="����1.A1:����1.D17 ����1.E1:����1.F17">
      <calcext:condition calcext:apply-style-name="����������1" calcext:value="begins-with(&quot;as&quot;)" calcext:base-cell-address="����1.A1"/>
      <calcext:condition calcext:apply-style-name="����������2" calcext:value="ends-with(&quot;ey&quot;)" calcext:base-cell-address="����1.A1"/>
      <calcext:condition calcext:apply-style-name="����������3" calcext:value="contains-text(&quot;et&quot;)" calcext:base-cell-address="����1.A1"/>
      <calcext:condition calcext:apply-style-name="����������4" calcext:value="not-contains-text(&quot;rt&quot;)" calcext:base-cell-address="����1.A1"/>
      <calcext:condition calcext:apply-style-name="����������5" calcext:value="between(1,20)" calcext:base-cell-address="����1.A1"/>
...
//    CodePageName: string              - �������� ������� ��������
//    BOM: ansistring                   - BOM
//  const WriteHelper: TZEODFWriteHelper- �������� ��� ������
//RETURN
//      integer
function ODFCreateStyles(var XMLSS: TZEXMLSS; Stream: TStream; const _pages: TIntegerDynArray;
...
//  var _style: TZSTyle       - ����������� �����
//  var StyleProperties: TZEODFStyleProperties - ������� ��� ��������� ��������������
...
//  var XMLSS: TZEXMLSS - ���������
//      stream: TStream - ����� ��� ������
//  var ReadHelper: TZEODFReadHelper - ��� �������� ���. ����
//RETURN
//      boolean - true - �� ��
...
var
  ...
  //                            ���� < 0 - ����� �� ��������.
  //                            ���� >= StyleCount, �� ����� � ������� ReadHelper.StylesProperties.
